...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('template-admin')}}/dist/css/adminx.css" media="screen" />
  </head>
  <body>
      ...
      <div class="page-login">
        <div class="text-center">
          <a class="navbar-brand mb-4 h1" href="login.html">
            <img src="{{asset('template-admin')}}/demo/img/logo.png" class="navbar-brand-image d-inline-block align-top mr-2" alt="">
            AdminX
          </a>
        </div>
    ...
    <script src="{{asset('template-admin')}}/dist/js/vendor.js"></script>
    <script src="{{asset('template-admin')}}/dist/js/adminx.js"></script>
